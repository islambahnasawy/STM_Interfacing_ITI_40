...
#define USART_CR1_LIN_SEND_BREAK_MASK			0x00000001

#define USART_CR2_STOP_CLEAR_MASK				0xffffcfff
#define USART_CR2_CLKEN_CLEAR_MASK				0xfffff7ff
#define USART_CR2_LBDIE_LBDL_CLEAR_MASK			0xffffff9f
#define USART_CR2_LIN_ENABLE_MASK				0x00004000


#define USART_CR3_LIN_INIT_CLEAR_MASK			0xffffffD5
