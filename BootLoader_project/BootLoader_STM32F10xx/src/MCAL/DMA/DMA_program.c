...
void DMA1_Channel4_IRQHandler(void)
{
	...
	if(x==0)
	{
		//trace_printf("sync byte and PID sent\n");
		x=1;
	}
	else if(x==1)
	{
		//trace_printf("data byte sent\n");
		x=2;
	}
	else if(x==2)
	{
		//trace_printf(" checksum byte sent\n");
		x=0;
	}
...
void DMA1_Channel5_IRQHandler(void)
{
	...
	if(x==0)
	{
		//trace_printf("break recieved\n");
		x=1;
	}
	else if(x==1)
	{
		//trace_printf("sync byte and PID recieved\n");
		x=2;
	}
	else if(x==2)
	{
		//trace_printf(" data byte and checksum byte(sent) recieved\n");
		x=0;
	}
